...
@property (nonatomic, copy) NSString * _Nullable requestUri;
- (nonnull instancetype)initWithScopes:(NSArray<UBSDKScope *> * _Nonnull)scopes requestUri:(NSString * _Nullable)requestUri OBJC_DESIGNATED_INITIALIZER;
...
@protocol UBSDKLoginButtonDataSource;
...
@property (nonatomic, weak) id <UBSDKLoginButtonDataSource> _Nullable dataSource;
...
SWIFT_PROTOCOL_NAMED("LoginButtonDataSource")
@protocol UBSDKLoginButtonDataSource
- (UBSDKPrefill * _Nullable)prefillValues:(UBSDKLoginButton * _Nonnull)button SWIFT_WARN_UNUSED_RESULT;
@end
...
///
/// \param prefillValues Optional values to pre-populate the signin form with.
///
/// \param completion The LoginManagerRequestTokenHandler completion handler for login success/failure.
///
- (void)loginWithRequestedScopes:(NSArray<UBSDKScope *> * _Nonnull)scopes presentingViewController:(UIViewController * _Nullable)presentingViewController prefillValues:(UBSDKPrefill * _Nullable)prefillValues completion:(void (^ _Nullable)(UBSDKAccessToken * _Nullable, NSError * _Nullable))completion;
...
SWIFT_CLASS_NAMED("Par")
@interface UBSDKPar : NSObject
/// An identifier used for profile sharing
@property (nonatomic, readonly, copy) NSString * _Nullable requestUri;
...
SWIFT_CLASS_NAMED("Prefill")
@interface UBSDKPrefill : NSObject
...
- (nonnull instancetype)initWithEmail:(NSString * _Nullable)email phoneNumber:(NSString * _Nullable)phoneNumber firstName:(NSString * _Nullable)firstName lastName:(NSString * _Nullable)lastName OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, UberProductType, closed) {
